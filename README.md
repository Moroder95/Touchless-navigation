...
| useRedirectPhone    | function | void | Returns a function that can be called if you want to redirect the connected phone to another URL. The returned function takes a string as input |
